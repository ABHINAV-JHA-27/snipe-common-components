...
import GoogleIcon from '../../../../public/assests/googleIcon.png';
    ...
    <div className="flex flex-col w-[70%]">
      ...
      {googleSigninVisible && (
        <div
          ...
          onClick={GoogleSignInOnClick ? GoogleSignInOnClick : () => {}}
        >
      ...
      <div className="flex flex-row gap-x-2 w-full items-center mt-4">
        <div
          className={clsx(
            ...
            dividerColor ? `border-[${dividerColor}]` : 'border-[#686673]'
          )}
        />
        <span
          className={clsx(
            'text-[14px] font-[500] font-DMSans',
            labelColor ? `text-[${labelColor}]` : 'text-[#686673]'
          )}
        >
          OR
        </span>
      ...
      <div className="flex flex-col gap-y-1 mt-4 w-full">
        ...
        <input
          ...
          className={clsx(
            ...
            inputBackgroundColor ? `bg-[${inputBackgroundColor}]` : 'bg-white',
            inputBorderColor
              ? `border-[${inputBorderColor}]`
              : 'border-blue-500',
            inputTextColor ? `text-[${inputTextColor}]` : 'text-black',
            inputTextSize ? `text-[${inputTextSize}]` : 'text-[14px]'
          )}
        />
      </div>
      <div className="flex flex-col gap-y-1 mt-4 w-full">
      ...
      <button
        className={clsx(
          ...
          submitButtonColor ? `bg-[${submitButtonColor}]` : 'bg-[#686673]'
        )}
        onClick={onSubmit}
      >
        Sign In
      ...
      <div className="flex flex-row  mt-6 w-full items-center justify-between font-[500] font-DMSans">
        <div className="flex flex-row item-center gap-x-2">
          New here?{' '}
          <p className="text-blue-500 underline" onClick={onNavigateToSignup}>
            Sign Up
          </p>
        </div>
        <p className="text-blue-500 underline" onClick={onForgotPassword}>
          Forgot Password?
        </p>
      </div>
    </div>
